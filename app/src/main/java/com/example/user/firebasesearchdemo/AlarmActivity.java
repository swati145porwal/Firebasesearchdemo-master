...
import com.example.user.firebasesearchdemo.data.AlarmReminderContract;
import com.example.user.firebasesearchdemo.data.AlarmReminderDbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(AlarmActivity.this, AddReminderActivity.class);
