...
public class SubstituteSetFragment extends Fragment implements View.OnKeyListener {
    ...
    private void firebaseUserSearch(String searchText) {
        ...
        Query firebaseSearchQuery = mUserDatabase.orderByChild("Content").equalTo(conts);

        FirebaseRecyclerAdapter<Medi, SubstituteSetFragment.UsersViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Medi, SubstituteSetFragment.UsersViewHolder>(

                Medi.class,
                R.layout.list_layout,
                SubstituteSetFragment.UsersViewHolder.class,
                firebaseSearchQuery

        ) {
            @Override
            protected void populateViewHolder(SubstituteSetFragment.UsersViewHolder viewHolder, Medi model, int position) {
